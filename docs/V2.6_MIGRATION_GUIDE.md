# CyborgMind V2.5 → V2.6 Migration Guide
...
✅ **V2.6 Alternative - Use Gymnasium**
```python
...
✅ **V2.6 Alternative - Custom Adapter**
```python
...
**What Changed:**
- All adapters enforce 128×128 pixel observations
- Custom image sizes trigger warnings but are overridden

**Migration:**

⚠️ **V2.5 Code (Works, but changes behavior)**
```python
...
- ✅ Same brain architecture (hidden_dim, vision_dim, etc.)
- ✅ Same memory configuration (num_slots, mem_dim)
- ✅ No custom CC3D-specific layers
...
**Migration complete? Welcome to V2.6! 🚀**
